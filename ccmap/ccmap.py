...
def DefineColormap(name):
    ...
    #     cmap = LinearSegmentedColormap.from_list("", ["#AD1457","#D81B60","#FFA000","#FDD835","#FFEE58"])
        ...
        cmap = LinearSegmentedColormap.from_list("", ["#BA68C8", "#9575CD", "#7986CB", "#64B5F6", "#4FC3F7", "#4DD0E1",
                                                      "#4DB6AC", "#81C784", "#AED581", "#DCE775", "#FFF176", "#FFD54F",
                                                      "#FFB74D", "#FF8A65", "#E57373", "#EF5350"])
    elif name == 'galaxy':
        cmap = LinearSegmentedColormap.from_list("",["#1B2631", "#283747", "#633974", "#F06292", "#AD1457"])
    elif name == 'sunset':
        cmap = LinearSegmentedColormap.from_list("", ["#000000", "#990033", "#FFCC00"])
    else:
